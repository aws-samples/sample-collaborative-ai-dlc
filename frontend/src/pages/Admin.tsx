      ...
      <div className="max-w-6xl mx-auto p-6 space-y-6">
        ...
        <Card>
          <CardHeader className="pb-3 pt-5 px-5">
            ...
            <p className="text-xs text-muted-foreground">
              Connect external tracker providers (Jira Cloud, GitHub Issues) by registering an
              OAuth app with each provider and pasting its credentials below. Users then connect
              their personal accounts from Project Settings → Trackers.
            </p>
          </CardHeader>
