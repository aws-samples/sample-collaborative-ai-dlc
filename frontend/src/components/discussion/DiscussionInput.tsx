...
// project members. Mentions are validated server-side anyway (non-members
// stripped) — the combobox just makes them typeable. The assist (Sparkles)
// menu lands with the assist-UI PR.
