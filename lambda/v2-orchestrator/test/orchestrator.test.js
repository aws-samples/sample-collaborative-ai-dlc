...
// defaultMintFreshToken — per-dispatch current git credential. GitHub App mode
// mints a repo-scoped installation token; GitLab/Bitbucket refresh their ~2h
// OAuth token just-in-time (via resolveGitToken → ensureFreshGitToken) so a
// lane dispatched after the run-start snapshot clones with a live token.
