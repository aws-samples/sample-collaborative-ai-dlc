...
test "$(docker image inspect "$image_ref" --format '{{.Config.User}}')" = "node"
test "$(docker image inspect "$image_ref" --format '{{json .Config.Entrypoint}}')" = '["node","/opt/agentcore/http-server.js"]'
