...
// Commercial-partition Regions where CodeCommit is offered, from
// https://docs.aws.amazon.com/codecommit/latest/userguide/regions.html
// (September 2026). The connect flow offers exactly these. China and GovCloud
// are other partitions: the platform's roles cannot assume a role there, so
// they are not offered.
export const CODECOMMIT_REGIONS = Object.freeze([
  'us-east-1',
  'us-east-2',
  'us-west-1',
  'us-west-2',
...
export const isSupportedCodeCommitRegion = (region) => CODECOMMIT_REGIONS.includes(region);
