// TEST FIXTURE — verbatim copy of core/tools/aidlc-sensor-type-check.ts from
// awslabs/aidlc-workflows @ ba0cfe999856033ecb909a9135b46fe10811bf55 (the pinned
// AIDLC_REPO_REF). This is the exact script the seed stores to S3 as a SENSOR's
// scriptRef; the script-sensor integration test runs it through the real runner
// with a real `bun` to prove the code-sensor path end-to-end. Keep in sync with
// the pin if it bumps. Do not edit the body — it must match what production runs.
//
