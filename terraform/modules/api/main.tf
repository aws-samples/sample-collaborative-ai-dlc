...
resource "aws_api_gateway_deployment" "main" {
  ...
  depends_on = [
    ...
    aws_api_gateway_integration.bitbucket_oauth_config_get,
    aws_api_gateway_integration.bitbucket_oauth_config_put,
  ...
  triggers = {
    redeployment = sha1(jsonencode([
      ...
      aws_api_gateway_resource.bitbucket_oauth_config.id,
