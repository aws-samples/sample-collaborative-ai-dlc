...
resource "aws_api_gateway_deployment" "main" {
  ...
  depends_on = [
    ...
    aws_api_gateway_integration.project_repos_get,
    aws_api_gateway_integration.project_repos_post,
    aws_api_gateway_integration.project_repos_delete,
  ...
  triggers = {
    redeployment = sha1(jsonencode([
      ...
      aws_api_gateway_resource.project_repos.id,
