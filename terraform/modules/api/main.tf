...
resource "aws_api_gateway_deployment" "main" {
  ...
  depends_on = [
    ...
    aws_api_gateway_integration.agent_pool_get,
    aws_api_gateway_integration.agent_pool_recycle_post,
    aws_api_gateway_integration.agent_pool_warm_post,
    aws_api_gateway_integration.agent_pool_worker_delete,
    aws_api_gateway_integration.agent_question_answer_post,
    aws_api_gateway_integration.agent_questions_get,
    aws_api_gateway_integration.agent_task_delete,
    ...
    aws_api_gateway_integration.gitlab_mr_notes_get,
    aws_api_gateway_integration.gitlab_mr_notes_post,
    aws_api_gateway_integration.gitlab_projects_branches_get,
    aws_api_gateway_integration.gitlab_projects_contents_get,
    aws_api_gateway_integration.gitlab_projects_tree_get,
    ...
    aws_api_gateway_integration.project_agents_post,
    aws_api_gateway_integration.project_mcp_servers_get,
    aws_api_gateway_integration.project_mcp_servers_put,
    aws_api_gateway_integration.project_steering_docs_get,
    aws_api_gateway_integration.project_steering_docs_put,
    aws_api_gateway_integration.task_mcp_servers_get,
    aws_api_gateway_integration.task_mcp_servers_put,
    aws_api_gateway_integration.task_steering_docs_get,
    aws_api_gateway_integration.task_steering_docs_put,
  ...
  triggers = {
    redeployment = sha1(jsonencode([
      ...
      aws_api_gateway_resource.gitlab_projects.id,
      aws_api_gateway_resource.gitlab_projects_branches.id,
      aws_api_gateway_resource.gitlab_projects_tree.id,
      aws_api_gateway_resource.gitlab_projects_contents.id,
      aws_api_gateway_resource.gitlab_projects_merge_requests.id,
      aws_api_gateway_resource.gitlab_projects_mr_iid.id,
      aws_api_gateway_resource.gitlab_projects_mr_notes.id,
      aws_api_gateway_method.gitlab_projects_branches_get.id,
      aws_api_gateway_method.gitlab_projects_tree_get.id,
      aws_api_gateway_method.gitlab_projects_contents_get.id,
      aws_api_gateway_method.gitlab_mr_notes_get.id,
      aws_api_gateway_method.gitlab_mr_notes_post.id,
      aws_api_gateway_integration.gitlab_projects_branches_get.id,
      aws_api_gateway_integration.gitlab_projects_tree_get.id,
      aws_api_gateway_integration.gitlab_projects_contents_get.id,
      aws_api_gateway_integration.gitlab_mr_notes_get.id,
      aws_api_gateway_integration.gitlab_mr_notes_post.id,
      ...
      aws_api_gateway_resource.discussion_message.id,
      aws_api_gateway_resource.discussion_message_redact.id,
      aws_api_gateway_resource.discussion_read.id,
      aws_api_gateway_resource.discussion_assist.id,
      ...
      aws_api_gateway_resource.project_mcp_servers.id,
      aws_api_gateway_resource.project_steering_docs.id,
      aws_api_gateway_resource.task_mcp_servers.id,
      aws_api_gateway_resource.task_steering_docs.id,
