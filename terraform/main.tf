...
module "api" {
  ...
  environment_reset_lambda_invoke_arn = module.managed_environments.reset_lambda_invoke_arn
  environment_reset_lambda_name       = module.managed_environments.reset_lambda_name
...
module "managed_environments" {
  ...
  vpc_security_group_ids         = [module.lambda.lambda_security_group_id]
  v2_executions_table_name       = module.agentcore.v2_executions_table_name
  v2_executions_table_arn        = module.agentcore.v2_executions_table_arn
  v2_orchestrator_qualified_name = module.lambda.v2_orchestrator_qualified_name
  v2_orchestrator_qualified_arn  = module.lambda.v2_orchestrator_qualified_arn
  cors_allowed_origins           = local.cors_allowed_origins
